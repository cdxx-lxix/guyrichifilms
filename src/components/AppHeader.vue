        ...
        <div class="max-w-[1170px] flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto" id="user-menu">
                <ul
                    ...
                    <li>
                        <RouterLink to="/#sale"
                            class="block py-2 px-4 text-gray-900 rounded hover:bg-gray-100 hover:bg-gray-600/30">Акции</RouterLink>
                    </li>
                </ul>
            </div>
            <div class="flex items-center w-1/6">
                <button type="button" class="flex flex-row items-center text-md gap-2 bg-transparent" id="user-basket" @click="showModal">
